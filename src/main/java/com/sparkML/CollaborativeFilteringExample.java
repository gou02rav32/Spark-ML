...
public class CollaborativeFilteringExample {
	...
	public static void collaborative()
	{
		...
		// Save and load model
		try {
			model.save(jsc.sc(), "target/data/collaFilter/col");
			MatrixFactorizationModel sameModel = MatrixFactorizationModel.load(jsc.sc(), "target/data/collaFilter/col");
			// $example off$
		}
