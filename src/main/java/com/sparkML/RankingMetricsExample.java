...
public class RankingMetricsExample {
	public static void main(String[] args) {
		rankingMetricsEx();
	}
	public static void rankingMetricsEx()
	{
		SparkConf conf = new SparkConf().setAppName("Java Ranking Metrics Example").setMaster("local[2]");
	    JavaSparkContext sc = new JavaSparkContext(conf);
	    // $example on$
	    String path = "/home/bizruntime/eclipse-workspace/sparkML/src/data/movieLens.txt";
