...
public class MultiLabelClassificationExample {
	public static void main(String[] args) {
		multilabelClassificationExample();
	}
	private static void multilabelClassificationExample()
	{
		 SparkConf conf = new SparkConf().setAppName("Multilabel Classification Metrics Example").setMaster("local[2]");
		    ...
		    // Summary stats
		    System.out.format("Confusion metrics = %f\n", metrics.accuracy());
