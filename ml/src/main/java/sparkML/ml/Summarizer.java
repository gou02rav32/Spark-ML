...
public class Summarizer implements Serializable{
    ...
    private void run() {
    	String path = "/home/bizruntime/temp.txt";
        SparkConf conf = new SparkConf().setAppName("Summarizer123").setMaster("local[2]");
        JavaSparkContext javaSparkContext = new JavaSparkContext(conf);
        JavaRDD<String> temparatureReadings = javaSparkContext.textFile(path);
