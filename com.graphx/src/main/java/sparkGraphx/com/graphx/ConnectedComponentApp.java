...
import scala.Tuple2;
public class ConnectedComponentApp {
	private static final Logger LOGGER = Logger.getLogger(ConnectedComponentApp.class);
	...
	public static void main(String[] args) {
		ConnectedComponentApp app = new ConnectedComponentApp();
		app.rank();
	}
